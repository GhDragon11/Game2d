...
class Menu:
    def __init__(self, window):
        self.window = window         # tive que mudar aqui pq o programa não estava achando a imagem, era "./asset/MenuBg.png"
        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    quit()  # end pygame       (TEM QUE CONTINUAR NO IF, POIS SE FOSSE ELIF SÓ FARIA O PRIMEIRO IF)
